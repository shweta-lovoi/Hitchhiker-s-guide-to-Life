    ...
    <body>
        ...
        <div style="background-color: #9cbab7" class="jumbotron jumbotron-fluid">
            <img src="/Final/pics/hurricane.jpg" alt="Hurricane" style="float:left;width:200px;height:200px;">
                <div class="container">
                    <h1 class="display-4">Nearby Disasters:</h1>
                    <p class="lead">Type in your city/state/country and check out which 
                        disasters are lurking around the corner:</p>
                    <form>
        ...
        <div class="card-deck">
            <div class="col-sm-12" >
                <div class="card text-center">
                    <div class="card-header" style="background-color: #9cbab7">Nearby Disasters:</div>
                    <iframe src="gcse4.jsp" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
